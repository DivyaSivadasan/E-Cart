          ...
          data?.map((item) => (
            <div className="p-2 ">
              <div className='p-3 rounded shadow-lg'>
                ...
                <h4 className='text-center text-3xl mt-5'>{item.title.slice(0, 12)}</h4>
                ...
                <div className='flex justify-between'>
                  <button onClick={() => dispatch(addWishlistItems(item))} className='px-5 py-3 rounded text-white bg-red-600 hover:border hover:bg-transparent hover:border-red-700 hover:text-red-700'><FontAwesomeIcon icon={faHeart} /></button>
